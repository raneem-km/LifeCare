      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-mobile md:px-margin-desktop py-lg max-w-7xl mx-auto">
        ...
        <div>
          ...
          <div className="relative">
            <input className="w-full bg-surface p-3 rounded-xl border-surface-variant/50 focus:border-secondary outline-none placeholder:text-slate-400 placeholder:font-normal text-slate-800" placeholder="Email Address" type="email" />
            <button className="absolute right-2 top-2 bg-secondary text-on-secondary p-1 rounded-lg flex items-center justify-center h-8 w-8 hover:scale-105 active:scale-95 transition-transform cursor-pointer">
